...
export default function SkillTab({ skill }: { skill: Skill }) {
  ...
  return (
    <div
      className={`text-base align-middle  pl-1 pr-2 py-1 rounded flex flex-row items-center gap-2 cursor-pointer w-max`}
      style={{
    ...
    >
      <div
        ...
        style={{ backgroundColor: isHovering ? '#111827' : skill.color }}
      ></div>
